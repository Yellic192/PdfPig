    ...
    public class PublicApiScannerTests
    {
        ...
        public void OnlyExposedApiIsPublic()
        {
            ...
            var expected = new List<string>
            {
                ...
                //"UglyToad.PdfPig.Core.Graphics.Colors.ColorSpace",
                //"UglyToad.PdfPig.Core.Graphics.Colors.IColor",
                ...
                //"UglyToad.PdfPig.Graphics.Core.Graphics.LineCapStyle",
                //"UglyToad.PdfPig.Graphics.Core.Graphics.LineDashPattern",
                //"UglyToad.PdfPig.Graphics.Core.Graphics.LineJoinStyle",
