namespace UglyToad.PdfPig.DocumentLayoutAnalysis
{
    ...
    public class TextBlock
    {
        ...
        {
            var obb = GeometryExtensions.MinimumAreaRectangle(lines.SelectMany(r => new[]
            {
            ...
            var avgAngle = lines.Average(l => l.BoundingBox.Rotation);

            var bbox = obb;
            var deltaAngle = Math.Abs(avgAngle - obb.Rotation);

            double deltaAngle1 = Math.Abs(avgAngle - obb1.Rotation);
            ...
            double deltaAngle2 = Math.Abs(avgAngle - obb2.Rotation);
            ...
            double deltaAngle3 = Math.Abs(avgAngle - obb3.Rotation);
