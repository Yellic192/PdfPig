namespace UglyToad.PdfPig.DocumentLayoutAnalysis.ReadingOrderDetector
{
    ...
    /// <para>Note: Make sure you use <see cref="BaseBlock.SetReadingOrder(int)"/> to set each <see cref="TextBlock"/> reading order when implementing <see cref="IReadingOrderDetector.Get(IReadOnlyList{TextBlock})"/>.</para>
    /// </summary>
