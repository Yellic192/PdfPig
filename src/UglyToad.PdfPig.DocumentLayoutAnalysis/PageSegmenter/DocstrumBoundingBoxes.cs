namespace UglyToad.PdfPig.DocumentLayoutAnalysis.PageSegmenter
{
    ...
    public class DocstrumBoundingBoxes : IPageSegmenter
    {
        ...
        /// <para>Uses betweenLineLowerBound = -30, betweenLineUpperBound = 30, betweenLineLowerBound = -135, betweenLineUpperBound = -45, betweenLineMultiplier = 1.3.</para>
        /// </summary>
        public static IPageSegmenter Instance { get; } = new DocstrumBoundingBoxes();
        ...
        private AngleBounds withinLine;
        private AngleBounds betweenLine;
        private double betweenLineMultiplier;

        /// <summary>
        /// Create a new <see cref="DocstrumBoundingBoxes"/>.
        /// <para>Uses betweenLineLowerBound = -30, betweenLineUpperBound = 30, betweenLineLowerBound = -135, betweenLineUpperBound = -45, betweenLineMultiplier = 1.3.</para>
        /// </summary>
        /// <param name="maxDegreeOfParallelism">Sets the maximum number of concurrent tasks enabled. 
        /// <para>A positive property value limits the number of concurrent operations to the set value. 
        /// If it is -1, there is no limit on the number of concurrently running operations.</para></param>
        public DocstrumBoundingBoxes(int maxDegreeOfParallelism = -1)
            : this(new AngleBounds(-30, 30), new AngleBounds(-135, -45), 1.3, maxDegreeOfParallelism)
        { }
        ...
        /// <para>A positive property value limits the number of concurrent operations to the set value. 
        /// If it is -1, there is no limit on the number of concurrently running operations.</para></param>
        public DocstrumBoundingBoxes(AngleBounds withinLine, AngleBounds betweenLine, double betweenLineMultiplier, int maxDegreeOfParallelism = -1)
        {
            this.withinLine = withinLine;
            this.betweenLine = betweenLine;
            this.betweenLineMultiplier = betweenLineMultiplier;
        ...
        public IEnumerable<TextBlock> GetBlocks(IEnumerable<Word> words)
        {
            return GetBlocks(words, withinLine, betweenLine, betweenLineMultiplier, MaxDegreeOfParallelism);
        }
        ...
        /// If it is -1, there is no limit on the number of concurrently running operations.</para></param>
        /// <returns>The <see cref="TextBlock"/>s generated by the document spectrum method.</returns>
        private IReadOnlyList<TextBlock> GetBlocks(IEnumerable<Word> words, AngleBounds withinLine,
        ...
        private static IEnumerable<TextBlock> GetLinesGroups(TextLine[] lines, double maxDist, int maxDegreeOfParallelism)
        {
            ...
            Func<PdfLine, PdfLine, double> euclidianOverlappingMiddleDistance = (l1, l2) =>
            {
                ...
                return Distances.Euclidean(new PdfPoint(left + d / 2, l1.Point1.Y),
