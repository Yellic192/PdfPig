namespace UglyToad.PdfPig.Functions
{
    ...
    internal sealed class PdfFunctionType3 : PdfFunction
    {
        ...
        private IReadOnlyList<PdfFunction> functionsArray;
        private double[] boundsValues;

        /// <summary>
        /// Stitching function
        /// </summary>
        public PdfFunctionType3(DictionaryToken function, IReadOnlyList<PdfFunction> functionsArray)
            : base(function)
        {
        ...
        /// Stitching function
        /// </summary>
        public PdfFunctionType3(StreamToken function, IReadOnlyList<PdfFunction> functionsArray)
            : base(function)
        {
            this.functionsArray = functionsArray;
        }
        ...
        public override double[] Eval(double[] input)
        {
            ...
            if (functionsArray == null)
            {
                ...
                {
                    functionsArray[i] = PdfFunctionParser.Create(ar[i]);
                }
            }
            */
