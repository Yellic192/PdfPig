namespace UglyToad.PdfPig.Graphics
{
    ...
    internal class ContentStreamProcessor : BaseStreamProcessor<PageContent>
    {
        ...
        /// </summary>
        internal readonly List<Union<XObjectContentRecord, InlineImage>> images = new List<Union<XObjectContentRecord, InlineImage>>();

        /// <summary>
        /// Stores each letter as it is encountered in the content stream.
        /// </summary>
        internal readonly List<Letter> letters = new List<Letter>();
        ...
        internal readonly MarkedContentStack markedContentStack = new MarkedContentStack();
        ...
        public override PageContent Process(int pageNumberCurrent, IReadOnlyList<IGraphicsStateOperation> operations)
        {
            ...
            return new PageContent(operations, letters, paths, images, markedContents,
        ...
        {
            // TODO - to override in child class PDFGraphicsStreamEngine
            AddCurrentSubpath();
