namespace UglyToad.PdfPig.Geometry
{
    ...
    public static class GeometryExtensions
    {
        ...
        internal static bool ccw(PdfPoint point1, PdfPoint point2, PdfPoint point3)
        {
        ...
        #region Generic line
        internal static bool Contains(PdfPoint pl1, PdfPoint pl2, PdfPoint point)
        {
        ...
        /// </summary>
        internal static bool IntersectsWith(PdfPoint p11, PdfPoint p12, PdfPoint p21, PdfPoint p22)
        {
        ...
        /// </summary>
        internal static PdfPoint? Intersect(PdfPoint p11, PdfPoint p12, PdfPoint p21, PdfPoint p22)
        {
        ...
        /// </summary>
        internal static PdfPoint? IntersectInfiniteLines(PdfPoint p11, PdfPoint p12, PdfPoint p21, PdfPoint p22)
        {
        ...
        internal static bool ParallelTo(PdfPoint p11, PdfPoint p12, PdfPoint p21, PdfPoint p22)
        {
        ...
        public static (BezierCurve, BezierCurve) Split(this PdfSubpath.BezierCurve bezierCurve, double tau)
        {
        ...
        /// <para>Avoid using this method as it is not optimised. Use <see cref="Intersect(PdfSubpath.BezierCurve, PdfLine)"/> instead.</para>
        /// </summary>
        ...
        /// <summary>
        /// Checks if the curve and the line are intersecting.
        /// <para>Avoid using this method as it is not optimised. Use <see cref="Intersect(PdfSubpath.BezierCurve, PdfSubpath.Line)"/> instead.</para>
        /// </summary>
        ...
        private static bool IntersectsWith(PdfSubpath.BezierCurve bezierCurve, PdfPoint p1, PdfPoint p2)
        {
        ...
        private static PdfPoint[] Intersect(PdfSubpath.BezierCurve bezierCurve, PdfPoint p1, PdfPoint p2)
        {
            ...
            foreach (var t in ts)
            {
                PdfPoint point = new PdfPoint(
                    PdfSubpath.BezierCurve.ValueWithT(bezierCurve.StartPoint.X,
                                           bezierCurve.FirstControlPoint.X,
                                           bezierCurve.SecondControlPoint.X,
                                           bezierCurve.EndPoint.X,
                                           t),
                    PdfSubpath.BezierCurve.ValueWithT(bezierCurve.StartPoint.Y,
        ...
        /// </summary>
        /// <returns>List of t values where the <see cref="PdfSubpath.BezierCurve"/> and the <see cref="PdfLine"/> intersect.</returns>
        ...
        /// Get the t values that are the intersections of the line and the curve.
        /// </summary>
        /// <returns>List of t values where the <see cref="PdfSubpath.BezierCurve"/> and the <see cref="PdfSubpath.Line"/> intersect.</returns>
        ...
        private static double[] IntersectT(PdfSubpath.BezierCurve bezierCurve, PdfPoint p1, PdfPoint p2)
        {
